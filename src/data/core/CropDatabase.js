...
export const CROP_SPECS = {
    ...
    'moong': { n: [20, 25], p: [45, 55], k: [20, 25], ph: [6.5, 7.5], rain: [600, 800], hum: [60, 75], temp: [25, 35], type: 'Pulse' },
    'urad': { n: [20, 30], p: [40, 50], k: [25, 35], ph: [6.5, 7.5], rain: [600, 1000], hum: [60, 80], temp: [25, 35], type: 'Pulse' },
    'masoor': { n: [15, 25], p: [35, 45], k: [15, 25], ph: [6.0, 7.5], rain: [300, 500], hum: [50, 60], temp: [15, 25], type: 'Pulse' },
    ...
    'muskmelon': { n: [70, 90], p: [45, 55], k: [35, 45], ph: [6.0, 7.0], rain: [400, 600], hum: [60, 75], temp: [25, 35], type: 'Fruit' },
    'litchi': { n: [60, 80], p: [35, 45], k: [60, 90], ph: [5.5, 6.5], rain: [1200, 1600], hum: [70, 80], temp: [25, 35], type: 'Fruit' },
    'coconut': { n: [500, 600], p: [300, 400], k: [800, 1000], ph: [5.5, 8.0], rain: [1500, 2500], hum: [70, 90], temp: [25, 30], type: 'Fruit' },
    'rose': { n: [50, 70], p: [60, 80], k: [40, 50], ph: [6.0, 6.5], rain: [700, 1000], hum: [50, 70], temp: [15, 28], type: 'Flower' },
...
export const METADATA = {
    ...
    'maize (corn)': { 
        ...
        loc: 'Karnataka, Bihar, MP', locInsight: 'Widely adaptability',
    ...
    'jowar': { 
        ...
        behavior: 'Climate-adaptabilityive crop', behaviorInsight: 'Adjusts to rainfall',
    ...
    'moong': { 
        ...
        loc: 'Rajasthan, WB, Maharashtra', locInsight: 'Widely adaptability',
    ...
    'tomato': { 
        ...
        loc: 'All India', locInsight: 'Highly adaptability',
    ...
    'rose': { 
        ...
        loc: 'All India', locInsight: 'Widely adaptability',
    ...
    'marigold': { 
        ...
        soil: 'Any well-drained soil', soilInsight: 'Highly adaptability',
        behavior: 'Hardy flowering crop', behaviorInsight: 'Resistant to stress',
        adaptability: 'All-time', adaptabilityInsight: 'Extremely adaptability',
    ...
    'hibiscus': { 
        ...
        adaptability: 'All-time', adaptabilityInsight: 'Highly adaptability',
    ...
    'guava': { 
        ...
        climate: 'Warm', climateInsight: 'Tolerates variation',
        soil: 'All soils (well-drained)', soilInsight: 'Very adaptability',
