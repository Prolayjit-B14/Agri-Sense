      ...
      >
        ...
        <div style={{ padding: '16px 20px', borderTop: `1px solid ${COLORS.border}`, background: 'rgba(0,0,0,0.12)' }}>
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ fontSize: '0.55rem', color: COLORS.primary, fontWeight: 800, marginTop: '2px', letterSpacing: '0.15em', textTransform: 'uppercase', opacity: 0.3 }}>Bharat Advisor Industrial</div>
          </div>
        </div>
      </motion.div>
